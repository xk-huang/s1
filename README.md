...
* 2025-02: We released s1.1 a better model than s1 by reusing the same s1K dataset but with reasoning traces generated by r1 instead of Gemini. Check [this tweet]() for details
